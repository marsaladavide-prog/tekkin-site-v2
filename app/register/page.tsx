...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      // Non facciamo redirect qui: aspettiamo il click sulla mail
      if (data) {
            ...
            <div className="space-y-4">
              <div className="rounded-lg border border-emerald-500/60 bg-emerald-500/10 px-3 py-3 text-sm text-emerald-100">
                ...
                <p className="mt-2 text-[11px] text-emerald-100/70">
                  Dopo il click verrai portato direttamente alla tua dashboard
                  Artist. Non dovrai rifare il login.
                </p>
              </div>

              <div className="text-xs text-[var(--text-muted)]">
                <p>
                  Non hai ricevuto la mail Se usi Gmail controlla anche
                  "Promozioni" o "Spam". Puoi anche riprovare a registrarti con
                  lo stesso indirizzo: Supabase in quel caso dovrebbe
                  reinviarti un link di accesso. Non posso confermare questo in
                  tutti i casi, ma è il comportamento descritto nella loro
                  documentazione.
                </p>
              </div>
          ...
          {!signupComplete && (
            <>
              <p className="mt-4 text-xs text-[var(--text-muted)]">
                Creando un account accetti la gestione dei tuoi dati come indicato nelle nostre policy.
              </p>
